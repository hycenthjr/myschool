...
import { LogIn, Phone, Menu, X, ShoppingCart } from "lucide-react";
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link to="/portal/student/login">
                <button className="flex items-center gap-1 border border-gray-200 rounded-md px-3 py-1 text-sm font-medium text-gray-700 hover:bg-gray-100 transition cursor-pointer">
                  <LogIn size={16} />
                  Portal Login
                </button>
              </Link>
