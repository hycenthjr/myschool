...
export function DialogContent({
  ...
  return (
    <DialogPortal>
      ...
      <div
        className={`fixed top-1/2 left-1/2 z-50 w-[95%] max-w-lg -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg p-6 ${className}`}
      >
        {children}
        ...
        >
          <XIcon className="w-5 h-5 bg-red-200"/>
        </button>
      </div>
    </DialogPortal>
  );
